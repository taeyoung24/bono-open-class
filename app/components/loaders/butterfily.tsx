...
const Loader = ({ variant = 'full' }: LoaderProps) => {
  return (
    <div className={`${styles.loaderContainer} ${variant === 'mini' ? styles.mini : ''}`}>
      <div className={`${styles.windLine} ${styles.wind1}`} />
      <div className={`${styles.windLine} ${styles.wind2}`} />
      <div className={`${styles.windLine} ${styles.wind3}`} />
      <div className={`${styles.windLine} ${styles.wind4}`} />
      <div className={`${styles.cloud} ${styles.cloud1}`} />
      <div className={`${styles.cloud} ${styles.cloud2}`} />
      <div className={styles.birdWrapper}>
        <svg className={styles.birdSvg} viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
